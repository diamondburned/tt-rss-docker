...
# PHP modules
RUN apk add --no-cache php7 php7-json php7-xml php7-plsql php7-pdo_pgsql php7-mbstring php7-fileinfo php7-opcache php7-fpm php7-gd php7-pdo php7-iconv php7-dom phpmyadmin 
